...
/**
 * Classe que vai modelar a natureza do pokémon. Cada Pokémon tem uma natureza,
 * selecionada aleatoriamente de um total de 25. A nature afeta o crescimento de
 * um Pokémon Cada natureza aumenta um dos seus atributos em 10% e diminui um
 * por 10% (no momento em que atinge o nível 100).
 * 
 * @author Keila
 * 
 */
...
public class Nature implements Serializable {
	...
	/**
	 * Nome do atributo do pokémon, que irá sem incrementado em 10% Atributos
	 * possíveis: Attack, Defense, Speed Attack, Speed Defense e Speed
	 */
	@Column(nullable = false)
	private String attributeIncrease;

	/**
	 * Nome do atributo do pokémon, que irá sem decrementado em 10% Atributos
	 * possíveis: Attack, Defense, Speed Attack, Speed Defense e Speed
	 */
	@Column(nullable = false)
...
//		try {
//			if(  this.attributeIncrease.toLowerCase().equals(Stat.class.getField(attributeIncrease).toString())  ) {
//			
//			}
//			
